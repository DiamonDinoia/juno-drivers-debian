...
install-core:
	...
	install -dm755 $(DESTDIR)/etc/pipewire
	...
	install -Dpm 0644 pipewire/pipewire-pulse.conf $(DESTDIR)/etc/pipewire/pipewire-pulse.conf
...
uninstall:
	...
	rm -f $(DESTDIR)/etc/pipewire/pipewire-pulse.conf